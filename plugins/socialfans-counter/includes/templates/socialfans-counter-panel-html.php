            ...
            <?php foreach ( $socials as $i => $social ) { ?>
              ...
              <div>
                <h3>
                  ...
                  <?php echo ($social == 'instgram' ? ucwords('instagram') : ucwords( strtolower( str_replace( '_' , ' ' , $social ) ) )); ?></h3>
                <div>
                  ...
                  <?php if ( $social == 'instgram' ) { // instgram Options ?>
                    <div class="form-field"><?php echo $this->getTextElement( 'Instagram ID' , $input_prefix . '[id]' , sfc_get_option( $social . '.id' ) ); ?></div>
                    <div class="form-field"><?php echo $this->getTextElement( 'Instagram Username' , $input_prefix . '[username]' , sfc_get_option( $social . '.username' ) ); ?></div>
                    <div class="form-field"><?php echo $this->getTextElement( 'Access Token' , $input_prefix . '[api_key]' , sfc_get_option( $social . '.api_key' ) ); ?></div>
