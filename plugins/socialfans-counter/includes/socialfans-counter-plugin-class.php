...
class SocialFans_Counter_Plugin {
    ...
    public function __construct() {
        ...
        add_action('wp_enqueue_scripts', array($this, 'getPluginFontsExtra'));
    ...
    public function register_front_assets() {
        ...
        wp_register_style( 'fontawesome-widget-style' , SOCIALFANS_COUNTER_URL . 'assets/css/font-awesome.min.css' , false , SOCIALFANS_COUNTER_VERSION );
        ...
        wp_enqueue_style( 'fontawesome-widget-style' );
    ...
    public function getPluginFontsExtra() {

        $fonts_url = SOCIALFANS_COUNTER_URL . 'assets/font/';

        $fonts = "<style type=\"text/css\">\n";
        $fonts .= "@font-face {\n";
        $fonts .= "\tfont-family: 'fontawesome';\n";

        $fonts .= sprintf("\tsrc: url('%s%s?v=%s');\n", $fonts_url, 'fontawesome.eot', SOCIALFANS_COUNTER_VERSION);
        $fonts .= sprintf("\tsrc: url('%s%s?v=%s#iefix') format('embedded-opentype'),\n", $fonts_url, 'fontawesome.eot', SOCIALFANS_COUNTER_VERSION);
        $fonts .= sprintf("\turl('%s%s?v=%s') format('woff'),\n", $fonts_url, 'fontawesome.woff', SOCIALFANS_COUNTER_VERSION);
        $fonts .= sprintf("\turl('%s%s?v=%s') format('woff2'),\n", $fonts_url, 'fontawesome.woff2', SOCIALFANS_COUNTER_VERSION);
        $fonts .= sprintf("\turl('%s%s?v=%s') format('truetype'),\n", $fonts_url, 'fontawesome.ttf', SOCIALFANS_COUNTER_VERSION);
        $fonts .= sprintf("\turl('%s%s?v=%s') format('svg');\n", $fonts_url, 'fontawesome.svg', SOCIALFANS_COUNTER_VERSION);
